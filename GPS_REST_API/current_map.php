...
FROM fact_vehicle_ping AS p WHERE p.status = 0 ) SELECT vin_pings.*, dim_vehicle.veh_id FROM vin_pings join dim_vehicle on vin_pings.vin = dim_vehicle.vin WHERE rn=1";
